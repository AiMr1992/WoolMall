 ...
 */
public class SpecialListInteractorImpl implements SpecialListInteractor{
    @Override
    public void getSpecialList(String id, String page,final SpecialListListener listener) {
