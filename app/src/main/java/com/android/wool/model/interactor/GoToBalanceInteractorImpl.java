 ...
 */
public class GoToBalanceInteractorImpl implements GoToBalanceInteractor{
    @Override
    public void getConfirm(Context context,final GoToBalanceListener listener) {
