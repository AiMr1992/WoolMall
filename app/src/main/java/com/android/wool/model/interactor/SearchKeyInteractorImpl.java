 ...
 */
public class SearchKeyInteractorImpl implements SearchKeyInteractor{
    @Override
    public void getHotSearch(final HotSearchListener listener) {
        ...
        ConnHttpHelper.getInstance().getServerApiPost(
                ...
                HttpConstant.SEARCH_HOT_SEARCH,
                map
        );
    }
}
