 ...
 */
public class LocationDelInteractorImpl implements LocationDelInteractor{
    @Override
    public void delLocation(String id, Context context,final LocationDelListener listener) {
