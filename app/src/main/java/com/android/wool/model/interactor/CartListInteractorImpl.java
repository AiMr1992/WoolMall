 ...
 */
public class CartListInteractorImpl implements CartListInteractor{
    @Override
    public void getCartList(Context context, String page,final CartListListener listener) {
