 ...
 */
public class LogisticsInteractorImpl implements LogisticsInteractor{
    @Override
    public void getLogisticsInfo(String order_no,final LogisticsListener listener) {
