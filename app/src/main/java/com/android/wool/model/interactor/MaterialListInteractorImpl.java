 ...
 */
public class MaterialListInteractorImpl implements MaterialListInteractor{
    @Override
    public void getMaterialList(String page,final MaterialListListener listener) {
