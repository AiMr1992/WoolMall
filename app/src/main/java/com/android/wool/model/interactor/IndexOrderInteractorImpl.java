 ...
 */
public class IndexOrderInteractorImpl implements IndexOrderInteractor{
    @Override
    public void getIndexOrder(String type,String page,final IndexOrderListener listener) {
