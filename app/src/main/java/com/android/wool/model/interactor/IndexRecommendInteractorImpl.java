 ...
 */
public class IndexRecommendInteractorImpl implements IndexRecommendInteractor{
    @Override
    public void getIndexRecommendList(String page,final IndexRecommendListener listener) {
