 ...
 */
public class HouseUpdateInteractorImpl implements HouseUpdateInteractor{
    @Override
    public void update(Context context, String goods_id, String type,final HouseUpdateListener listener) {
